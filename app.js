...
// Load data from olympics_data.csv
// d3.csv("olympics_data.csv").then(function(olympicsData) {
...
// Load data from olympics_data.csv
d3.csv("Female-Sports/female_athletes_gold.csv").then(function(athletesData) {
